...
const Postedjob = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://job-portal-severside-management-system.vercel.app/jobs?email=${user.email}`, { withCredentials: true })
            .then(res => setJobs(res.data))
        // fetch(`https://job-portal-severside-management-system.vercel.app/jobs?email=${user.email}`)
        //     .then((res) => res.json())
